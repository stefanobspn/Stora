    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(onClick = {
                viewModel.setMemberForEditing(null)
            ...
            LazyColumn(
                ...
                items(members) { member ->
                    MemberItemRow(member = member, onClick = {
                        viewModel.setMemberForEditing(member)
                        onNavigateToAddMember()
                    })
                }
            }
...
@Composable
fun MemberItemRow(member: Member, onClick: () -> Unit) {
    Card(
        ...
        Row(
            ...
            Column {
                ...
                Text(member.phoneNumber, style = MaterialTheme.typography.bodyMedium)
                Text("${member.points} Poin", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.primary)
            }
        }
    }
}
